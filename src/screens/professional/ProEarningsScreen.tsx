...
const ProEarningsScreen = () => {
  ...
  const { earnings, isLoading, error, refresh } = useProfessionalEarningsScreen();
      ...
      <View style={styles.contentContainer}>
            ...
            <View style={styles.filterContainer}>
              {(['week', 'month', 'year'] as const).map((filter) => (
                <TouchableOpacity
                  ...
                  <Text
                    style={[styles.filterText, timeFilter === filter && styles.activeFilterText]}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.infoText}>
            Your earnings are processed weekly and transferred to your bank account within 2-3
            business days.
          </Text>
          <TouchableOpacity
