...
const ProServiceAreaScreen = () => {
  ...
  } = useApi(() => httpClient.get('/professionals/service-areas'), { showErrorAlert: false });
  ...
  const filteredAreas = availableAreas
    .filter(
      (area) =>
        area.name.toLowerCase().includes(searchQuery.toLowerCase()) && area.distance <= maxDistance
    )
        ...
        <View style={styles.summaryCard}>
          <View style={styles.summaryHeader}>
            ...
            <View style={styles.summaryBadge}>
              <Text style={styles.summaryBadgeText}>{selectedAreas.length} Selected</Text>
            </View>
          </View>
          <View style={styles.summaryDetailRow}>
            <FontAwesome5 name="briefcase" size={14} color={colors.gray600} />
            <Text style={styles.summaryDetailText}>
              Estimated {totalEstimatedJobs} jobs per week
            </Text>
          </View>
        </View>
            ...
            <View style={styles.card}>
              {filteredAreas.map((area, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.areaItem,
                    index === filteredAreas.length - 1 && styles.lastAreaItem,
                  ]}
