...
const BookingsScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}><Text style={styles.headerText}>My Bookings</Text></View>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#fff', paddingTop: 48, paddingBottom: 16, paddingHorizontal: 16, borderBottomWidth: 1, borderColor: '#e5e7eb' },
