...
const styles = StyleSheet.create({
  ...
  headerCount: { marginLeft: 8, color: '#6b7280' },
  ...
  emptyDescription: { color: '#6b7280', textAlign: 'center', marginBottom: 24 },
  browseButton: { backgroundColor: '#2563eb', borderRadius: 12, paddingVertical: 16, paddingHorizontal: 32 },
  browseButtonText: { color: '#fff', fontWeight: 'bold' },
  scrollView: { flex: 1 },
  cartList: { padding: 16 },
  cartItem: { flexDirection: 'row', backgroundColor: '#f9fafb', borderRadius: 12, padding: 12, marginBottom: 16 },
  itemImage: { width: 80, height: 80, borderRadius: 8 },
  itemInfo: { flex: 1, marginLeft: 12, justifyContent: 'space-between' },
  itemTitle: { fontSize: 16, fontWeight: '600', color: '#1f2937' },
  itemPrice: { color: '#2563eb', fontWeight: '600' },
  quantityRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  quantityControls: { flexDirection: 'row', alignItems: 'center' },
  quantityButton: { width: 32, height: 32, backgroundColor: '#e5e7eb', borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
  quantityText: { marginHorizontal: 12, fontWeight: '600' },
  section: { padding: 16, borderTopWidth: 1, borderColor: '#e5e7eb' },
  sectionTitle: { fontSize: 16, fontWeight: '600', marginBottom: 8 },
  promoRow: { flexDirection: 'row' },
  promoInput: { flex: 1, borderWidth: 1, borderColor: '#d1d5db', borderTopLeftRadius: 12, borderBottomLeftRadius: 12, paddingHorizontal: 16, paddingVertical: 12 },
  promoButton: { backgroundColor: '#2563eb', justifyContent: 'center', paddingHorizontal: 16, borderTopRightRadius: 12, borderBottomRightRadius: 12 },
  promoButtonText: { color: '#fff', fontWeight: '600' },
  promoHint: { fontSize: 12, color: '#6b7280', marginTop: 8 },
  ...
  discountText: { color: '#16a34a', fontWeight: '600' },
  summaryText: { fontWeight: '600' },
  totalText: { fontSize: 18, fontWeight: 'bold' },
  totalAmount: { fontSize: 18, fontWeight: 'bold', color: '#2563eb' },
  checkoutContainer: { padding: 16, borderTopWidth: 1, borderColor: '#e5e7eb' },
  checkoutButton: { backgroundColor: '#2563eb', borderRadius: 12, paddingVertical: 16, justifyContent: 'center', alignItems: 'center' },
