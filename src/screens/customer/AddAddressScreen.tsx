...
// type AddAddressScreenNavigationProp = NativeStackNavigationProp<CustomerStackParamList>;
// type AddAddressScreenRouteProp = RouteProp<CustomerStackParamList, 'AddAddress'>;
...
//     if (currentLocation) {
//       // In a real app, you would parse the location data properly
//       // For demo purposes, we'll set mock values
